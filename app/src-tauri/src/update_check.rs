...
pub const RELEASES_PAGE_URL: &str = "https://github.com/n8watkins/localdictate/releases/latest";
const LATEST_RELEASE_API: &str =
    "https://api.github.com/repos/n8watkins/localdictate/releases/latest";
