<!--
  Vendored copy of the frozen v1 wire contract this MCP server is a client of.
  Canonical home: docs/integrations/dictation-state-contract.md (owned by the
  Scribe app / producer). Kept here verbatim so this package is self-contained
  and can be built and reviewed without the producer's branch. v1 is FROZEN.
-->
